...
/*
  Make sure OtlpJsonHttpLogRecordExporterFactory does not require,
...
TEST(OtlpJsonHttpLogRecordExporterFactoryTest, BuildTest)
{
  OtlpHttpLogRecordExporterOptions opts;
  opts.url = "localhost:45454";

  std::unique_ptr<opentelemetry::sdk::logs::LogRecordExporter> exporter =
      OtlpJsonHttpLogRecordExporterFactory::Create(opts);
