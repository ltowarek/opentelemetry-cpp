...
/*
  Make sure OtlpJsonHttpMetricExporterFactory does not require,
...
TEST(OtlpJsonHttpMetricExporterFactoryTest, BuildTest)
{
  OtlpHttpMetricExporterOptions opts;
  opts.url = "localhost:45454";

  std::unique_ptr<opentelemetry::sdk::metrics::PushMetricExporter> exporter =
      OtlpJsonHttpMetricExporterFactory::Create(opts);
