...
/**
 * Factory class for OtlpJsonHttpExporter.
 *
 * The header pulls in neither protobuf nor a JSON backend, so a consumer can
 * select the protobuf-free span exporter without either appearing in its
 * own translation unit.
 */
class OPENTELEMETRY_EXPORT OtlpJsonHttpExporterFactory
{
public:
  /**
  ...
  /**
   * Create an OtlpJsonHttpExporter using the given options, runtime options, HTTP client and JSON
   * backends.
   *
